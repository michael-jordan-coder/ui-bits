...
export default function TagInput({
  ...
  const [tags, setTags] = useState(() => defaultTags.slice(0, maxTags));
  ...
  const spring = prefersReduced ? { duration: 0 } : { type: 'spring', stiffness: 600, damping: 32 };

  return (
    <div className={join('tag-input', className)} {...rest}>
      ...
      <div
        ...
        style={{ background: surfaceColor, '--tag-input-accent': accentColor }}
