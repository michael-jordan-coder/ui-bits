...
import { Plus, Share2, Copy, Heart, Star, Trash2, Pencil, Download } from 'lucide-react';
...
export default function SpeedDial({
  ...
  const transition = prefersReduced ? { duration: 0 } : { type: 'spring', stiffness: 520, damping: 30 };

  return (
    <div className={join('speed-dial-root', className)} {...hoverProps} {...rest}>
      <AnimatePresence>
        {open && (
