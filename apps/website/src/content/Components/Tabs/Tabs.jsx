...
export default function Tabs({
  ...
  const indicatorTransition = prefersReduced ? { duration: 0 } : { type: 'spring', stiffness: 520, damping: 38 };
  const slide = prefersReduced ? 0 : 8;
  const current = items[active];

  return (
    <div className={join('tabs-root', className)} style={{ background: surfaceColor }} {...rest}>
