...
export default function TiltCard({
  ...
  return (
    <div className={join('inline-flex items-center justify-center', className)} style={{ perspective }} {...rest}>
      <motion.div
        ref={ref}
        className="relative shadow-[0_18px_40px_rgba(0,0,0,0.35),0_4px_10px_rgba(0,0,0,0.25)] will-change-transform"
        style={{
          borderRadius: radius,
      ...
      >
        ...
        {glare && !prefersReduced && (
          <motion.div
            className="pointer-events-none absolute inset-0 transition-opacity duration-300 ease-out [mix-blend-mode:soft-light]"
