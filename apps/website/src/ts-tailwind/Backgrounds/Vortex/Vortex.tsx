...
// utility classes. Particles live in polar coordinates around the center,
// spinning faster as they near the core and contracting inward, respawning at
// the rim — a continuous spiral inflow. A low-alpha surfaceColor veil each frame
// leaves trails. Single rAF loop, dpr-scaled canvas, ResizeObserver. Honors
...
export default function Vortex({
  ...
  useEffect(() => {
    ...
    const spawn = (atEdge: boolean): Particle => ({
      angle: rand(0, TAU),
