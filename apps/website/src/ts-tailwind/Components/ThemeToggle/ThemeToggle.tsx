...
export default function ThemeToggle({
  ...
  return (
    <div className={join('inline-flex items-center gap-[0.6rem] text-white', className)} {...rest}>
      <motion.button
        type="button"
        role="switch"
        aria-checked={isDark}
        aria-label="Toggle dark mode"
        className="relative block cursor-pointer border-none outline-none [-webkit-tap-highlight-color:transparent] shadow-[inset_0_1px_3px_rgba(0,0,0,0.25)] focus-visible:shadow-[inset_0_1px_3px_rgba(0,0,0,0.25),0_0_0_3px_rgba(255,255,255,0.35)]"
      ...
      >
        ...
        <motion.span
          className="relative grid place-items-center rounded-full bg-[#fffdf7] shadow-[0_2px_6px_rgba(0,0,0,0.3)] will-change-transform"
        ...
        >
          <AnimatePresence initial={false} mode="wait">
            {isDark ? (
              <motion.span
                key="moon"
                className="grid place-items-center leading-[0]"
      ...
      {showLabel && (
        <span className="min-w-[3ch] text-[0.9rem] font-semibold tracking-[-0.01em]" aria-live="polite">
