...
export type TagSphereTag = string | { label: string; value?: string; href?: string };
...
function normalizeTags(tags: TagSphereTag[]): NormalizedTag[] {
...
export default function TagSphere({
  ...
  const rootStyle: CSSProperties = {
    ...
    ...(accentColor ? ({ '--tag-sphere-accent': accentColor } as CSSProperties) : null),
    ...style
  };
