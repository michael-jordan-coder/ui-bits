...
export default function CubeShowcase({
  ...
  const findActive = useMemo(
    () => (currentX: number, currentY: number): number => {
      let bestI = 0;
  ...
  const rootStyle: CSSProperties = {
    ...
    ...(accentColor ? ({ ['--cube-showcase-accent' as string]: accentColor } as CSSProperties) : null),
    ...style
  };
                  ...
                  style={
                    {
                      ...
                      ...(face.color ? { ['--cube-showcase-face-color' as string]: face.color } : null)
                    } as CSSProperties
                  }
                >
