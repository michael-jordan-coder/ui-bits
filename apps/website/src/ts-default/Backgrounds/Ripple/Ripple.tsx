import { useCallback, useState, type PointerEvent as ReactPointerEvent, type HTMLAttributes } from 'react';
...
export interface RippleProps extends Omit<HTMLAttributes<HTMLDivElement>, 'color'> {
  color?: string;
