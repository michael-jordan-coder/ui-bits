...
function TimelineRow({ index, total, progress, accent, reduce }: TimelineRowProps) {
...
export interface ScrollTimelineProps extends HTMLAttributes<HTMLDivElement> {
  items?: number;
  accent?: string;
  height?: number;
  className?: string;
...
export default function ScrollTimeline({ items = 5, accent = '#3ecf8e', height = 460, className = '', ...rest }: ScrollTimelineProps) {
